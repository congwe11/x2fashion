...
parser.add_argument("--pretrained_model", default="pretrained_model/model_1000_133000.pth", help="Path to a pretrained model")
...
for i, batch in enumerate(train_dataloader):
    ...
    video_name = os.path.join("metrics/gen_result_woText", f'{name}_{start}_{start+24}.mp4')
